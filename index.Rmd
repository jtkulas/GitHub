...
Git is a platform tool that is used by software developers for source code management.  You need it in order to use GitHub. To install Git on you computer, [go to the website](https://git-scm.com/downloads). Here is what the website should look like:  
...
.pull-right[
Follow the download instructions and <span style="color:royalblue">take note of where Git is located on your computer</span> (e.g., what is the folder location?). 

+ You will most likely need this information when connecting to GitHub from within `r icon_style(fontawesome("r-project"), fill="royalblue")` studio.
]

...
<div class="my-footer"><span>Press the "h" key to access presentation options</span></div>
...
.left-column[# Using GitHub `r icon::fa_github(animate="rotate")` through `r icon::fa("r-project", color="cornflowerblue")` Studio 
]
...
This [site](https://happygitwithr.com/install-git.html) as well as the next few slides walk you through the setup. An entire book dedicated to Git and R Studio integration is [located here](https://happygitwithr.com/)
...
Git is platform tool that helps connect the website [GitHub](https://github.com/), and R studio. To install Git on you computer go to the website <https://git-scm.com/downloads>. Here is what the website should look like:  
...
## After you've successfully installed "Git" onto your computer

.pull-left[
### Step 1: Connect Git to `R`  
...
.center[<font size="5">.fancy[...you are now ready to connect to GitHub with R Studio]</font>
]
...
## .fancy[[Connecting your account to a GitHub project (Step I)](https://www.youtube.com/watch?v=YxZ8J2rqhEM)]

First access the GitHub repository you want to connect to, then copy the url to your clipboard:
...
## .fancy[[Connecting your account to a GitHub project (Step II)](https://www.youtube.com/watch?v=YxZ8J2rqhEM)]

Within the R Studio interface follow the wizard via: File $\rightarrow$ *New Project* $\rightarrow$ Version Control: 
...
## .fancy[[Connecting your account to a GitHub project (Step III)](https://www.youtube.com/watch?v=YxZ8J2rqhEM)]

Continue with $\rightarrow$ Git and then paste the GitHub repository address into the `Repository URL:` window.
...
## .fancy[Connecting your account to a GitHub project (Success!!!)] 
...
You can now work on shared `r icon::fa("r-project")` files via local editing. A "commit" saves your edits, whereas a "push" sends your saved changes (aka "commits") to the online GitHub repository.
...
...you'll need to know their GitHub username
...
## .fancy[Connecting to a GitHub repository]

1. Go to Github, and click on code, then copy the link
2. From within RStudio, you will go to "New Project"
3. Go to "verison control", click on "Git"
...
If you find a repository that you'd like to copy (e.g., use it as a template), then "fork".
...
It's important to commit and push all these files....

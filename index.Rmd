...
# Using GitHub `r icon::fa_github(animate="rotate")` through R Studio 

---
class: inverse

### Eagle I.O Contributors
<font size="5"> 
.pull-left[
...
1. How (and why) to integrate GitHub `r icon::fa("github")` and R Studio `r icon::fa("r-project")`

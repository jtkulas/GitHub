...
<font size="5"> 
.pull-right[
### Summer 2020 [Eagle I.O](https://eagle-io.weebly.com/) Team:
...
### Using GitHub `r icon::fa_github(animate="rotate")` through R Studio (alternative)
<font size="5"> 
.pull-left[
[`r  icon::fa_linkedin(colour = "cornflowerblue")`](https://www.linkedin.com/in/renatagppr/) .fancy[Renata Garcia Prieto Palacios Roji]  
![](renata.jpg)
...
## .fancy[Connecting individual accounts to shared projects (Step I)]
...
## .fancy[Connecting individual accounts to shared projects [(Step II)](https://www.youtube.com/watch?v=YxZ8J2rqhEM)]

...
WE NEED SCREENSHOTS OF THIS

Within the R Studio interface follow the wizard via: File $\rightarrow$ *New Project* $\rightarrow$ Version Control $\rightarrow$ Git $\rightarrow$ paste the GitHub repository address into the "Repository URL:" window.
...
## .fancy[Connecting individual accounts to shared projects (Success!!!)] 

...
Before accessing GitHub through `r icon_style(fontawesome("r-project"), fill="royalblue")` Studio, you first need to install "Git" onto your computer .
...
Follow the download instructions and take note of where Git is located on your computer (e.g., what is the folder location?). You will most likely need this information when connecting to GitHub from within `r icon_style(fontawesome("r-project"), fill="royalblue")` studio.

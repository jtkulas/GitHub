...
4. Advanced topics ([slides 22-52](#advanced))
...
## Why you want to do this: I. `r emo::ji("cool")`
...
---
## Why you want to do this: II. `r emo::ji("floppy_disk")`
...
There is an option to be notified (via e-mail) when somebody makes a push to a repository .saltinline[**that you "own"**]. This alerts you to the fact that a change has been made, and reminds you that you should "pull" prior to working on the project. To activate these notifications, navigate to the repository on GitHub, then enter your e-mail address... 
...
## .fancy[Pull request]: `r emo::ji("magnet")`
...
???
Pull requests are also used when you want to contribute to a repository where you're not a formal owner or collaborator - this is very popular with "open source" projects.

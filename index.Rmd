...
Take note here that if you try "pulling" prior to committing your local changes, you will encounter a **conflict**

.pull-left[
![](https://media.giphy.com/media/lojil9HflxEjOq4gBz/giphy.gif)
]

.pull-right[.large[We do have a suggested work-around for when this happens...]]
...
Working from within your `terminal`, the two git commands below will: 1) stash your local changes in a different location, and 2) delete those stashed files

.pull-left[ 
Take note here that any **new** work you've done locally will be obliviated... this work-around is therefore only useful if the information on the repository should reasonably be considered *more* important or *more* up-to-date:

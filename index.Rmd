...
.pull-left[
Using a version control platform (such as [GitHub](https://www.github.com)) facilitates collaboration on projects from multiple people by limiting the number of *different versions* that exist of the collaborative material.]
...
---
## Why you want to do this `r emo::ji("wizard")`

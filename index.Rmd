...
Working from within your `terminal`, the two git commands enumerated below will: 1) **stash** your local changes (away from your shared repository), and 2) permanantly delete those stashed files

.pull-left[ 
Take note here that any **new** work you've done locally will be obliviated... this work-around is therefore primarily useful when the information on the repository is reasonably considered to be *more* important or *more* up-to-date:

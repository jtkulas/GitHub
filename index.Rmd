...
.left-column[# Using GitHub `r icon::fa_github(color="black")` through `r icon::fa("r-project", color="cornflowerblue")` Studio 
]
...
You first need to install "Git" onto your computer before using GitHub through R Studio.
...
.pull-left[
### Step 1: Connect Git to `r icon::fa("r-project")`  
...
## Step 2: Connect Git To `r icon::fa("r-project")`
...
You can also invite collaborators from within the GitHub repo but you'll first need to know their GitHub username
